...
public class MiddlePriorityTasksFragment extends Fragment {
    ...
    private MiddlePriorityTasksAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viewModel.getTasksByPriority(DefaultParameters.MIDDLE_PRIORITY_TASK).observe(getViewLifecycleOwner(), new Observer<List<Task>>() {
            @Override
        ...
        adapter = new MiddlePriorityTasksAdapter(requireContext(), taskList, collapsableTaskList, getParentFragmentManager(), listener);
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    if(t.getTask_status() != DefaultParameters.TASK_UNSUCCESSFUL)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            int task_priority = DefaultParameters.MIDDLE_PRIORITY_TASK;
        ...
        fabCreateTask.setOnClickListener(v -> {
            ...
            bundle.putInt("priority", DefaultParameters.MIDDLE_PRIORITY_TASK);
