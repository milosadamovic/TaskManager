...
public class LowPriorityTasksAdapter extends RecyclerView.Adapter<LowPriorityTasksAdapter.CustomViewHolder> {
    ...
    public LowPriorityTasksAdapter(Context ctx, List<Task> taskList, List<Boolean> collapsableTaskList, FragmentManager fm, OnButtonAddTaskClickedListener listener)
    {
        this.ctx = ctx;
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.low_priority_task_item, parent, false);
